...
const FidoComponent = ({type, setType, recov}) => {
  ...
  return (
    <div className='h-screen bg-black overflow-auto'>
      ...
      <div className="w-[22em] mt-[10em] bg-zinc-800 opacity-90  dark:bg-zinc-800 dark:border-zinc-700 p-2 py-10 mb-2 rounded-lg shadow dark:border sm:max-w-md flex flex-col justify-center items-center">
