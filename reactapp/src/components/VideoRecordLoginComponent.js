...
const VideoRecorder = () => {
  ...
  return (
    <div className='h-screen bg-black overflow-auto'>
      ...
      {localStorage.getItem('username') && <p className='font-bold fixed top-20 leading-tight tracking-tight text-gray-400 mb-8 pr-4 pt-4 pl-4 md:text-xl dark:text-white'>Username : {localStorage.getItem('username')}</p>}
