...
from liveliness.model_lib.MiniFASNet import MiniFASNetV1, MiniFASNetV2,MiniFASNetV1SE,MiniFASNetV2SE
from liveliness.data_io import transform as trans
from liveliness.utility import get_kernel, parse_model_name
...
class AntiSpoofPredict(Detection):
    def __init__(self, device_id, model_path):
        ...
        print("Load model {} successfully.".format(self.model_name))
        self.model.eval()
